...
Version  : 1.10.2
Release  : 6
URL      : https://github.com/symless/synergy-core/archive/v1.10.2-stable/synergy-core-1.10.2.tar.gz
Source0  : https://github.com/symless/synergy-core/archive/v1.10.2-stable/synergy-core-1.10.2.tar.gz
...
%prep
%setup -q -n synergy-core-1.10.2-stable
%patch1 -p1
%patch2 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1557787620
mkdir -p clr-build
pushd clr-build
