...
Version  : 1.10.3
Release  : 7
URL      : https://github.com/symless/synergy-core/archive/v1.10.3-stable/synergy-core-1.10.3.tar.gz
Source0  : https://github.com/symless/synergy-core/archive/v1.10.3-stable/synergy-core-1.10.3.tar.gz
...
%prep
%setup -q -n synergy-core-1.10.3-stable
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1567615644
mkdir -p clr-build
pushd clr-build
